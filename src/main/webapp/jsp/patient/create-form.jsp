    ...
    <div class="col-12 ">
      ...
      <div class="card shadow-sm border-0">
        <div class="card-header bg-transparent text-center">
          <h5 class="mb-0 text-primary">Register a New Patient</h5>
          ...
          <form id="patientForm" class="row g-3 needs-validation" novalidate>
            ...
            <div class="col-md-6">
              ...
              <div class="input-group">
                ...
                <input type="text" id="name" name="firstName" class="form-control" placeholder="Patient's full name" required>
              </div>
            </div>
            ...
            <div class="col-md-6">
              ...
              <div class="input-group">
                ...
                <input type="tel" id="contact" name="contact" class="form-control" placeholder="Phone number" required>
              </div>
            ...
            <div class="col-md-6">
              ...
              <div class="input-group">
                ...
                <input type="number" id="age" name="age" class="form-control" placeholder="Age" min="0" max="120">
              </div>
            </div>
            ...
            <div class="col-md-6">
              ...
              <div class="input-group">
                ...
                <input type="text" id="emmergenceName" name="emergencyName" class="form-control" placeholder="Emergency contact name" required>
              </div>
            </div>
            ...
            <div class="col-md-6">
              ...
              <div class="input-group">
                <span class="input-group-text"><i class="bi bi-telephone"></i></span>
                <input type="tel" id="emmergencyContact" name="emergencyContact" class="form-control" placeholder="Emergency phone" required>
              </div>
            </div>

            <!-- Submit -->
            <div class="col-12 text-end">
              <button type="button" id="createBtn" onclick="savePatient()" class="btn btn-outline-primary px-4">
