				  ...
				  <p class="text-center small">Update Machine Information</p>
					<form id="myForm" class="row g-3 needs-validation" style=" margin-left: 5%;">
						<label for="name" class="col-md-4 col-lg-3 col-form-label">Name</label>
	                      ...
	                      <div class="col-md-8 col-lg-9">
	                        <input name="plateLength" type="number" class="form-control" id="plateWidth" value="${findMachine.plateWidth}">
	                      </div>
                     	 ...
                     	 <input data-bs-toggle="modal" type="button"  onclick="updateMachine'(${findMachine.id}')"
