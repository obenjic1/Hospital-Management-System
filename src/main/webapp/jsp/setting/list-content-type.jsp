	...
	<div class="pagetitle">
		<nav>
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item"><fmt:message key="content.type"/></li>
	...
	<section class="section">
		<div class="row">
			<div class="col-lg-12">
				<div class="card">
					<div class="card-body">
						<h5 class="card-title"> <fmt:message key="content.type"/></h5>
						...
						<table class="table datatable">
						  ...
						  <tbody>
						  <c:forEach var="content" items="${allContent}" varStatus="loop">
