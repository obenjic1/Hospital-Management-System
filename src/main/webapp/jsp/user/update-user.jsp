				  ...
				  <p class="text-center small"><fmt:message key="enter.the.user.informations"/></p>
					<form id="myForm" class="row g-3 needs-validation" style=" margin-left: 5%;">
					  <div class="col-md-6">
						...
						<div class="col-md-6">
						  <input data-bs-toggle="modal" data-bs-target="#creation" type="button" onclick="updateUserById('${userFinded.id}')" class="btn btn-primary" value="Save Changes" style="left: 164%;bottom: -18%;"/>
						</div>
					</form>
				</div>
			</div>
