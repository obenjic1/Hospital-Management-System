...
<body>
	...
	<header id="header" class="header fixed-top d-flex align-items-center">
		...
		<nav class="header-nav ms-auto">
			<ul class="d-flex align-items-center">
				...
				<!------------------ Select language ------------------>
				<li class="choose-language"><a
					href="${pageContext.request.contextPath}/?lang=fr"><fmt:message
							key="lang.fr" /> /</a> <a
					href="${pageContext.request.contextPath}/?lang=en"><fmt:message
							key="lang.en" /></a></li>
					...
					<span><fmt:message key="administration.managemant" /></span>
						  <sec:authorize access="hasRole('ROLE_LIST_USERS')">
							  ...
							  <a class="nav-link collapsed"
								 onclick="loadPage('/user/list-users')" href="#"> 
	...
	<footer id="footer" class="footer">
		<div class="copyright">
			&copy; Copyright <strong><span>Billing system</span></strong>. All
			Rights Reserved
		</div>
		<div class="credits">
