...
alert("hello its me joc activity option js");
		...
		fetch('/activityOption/add-activity', {
			...
			.then(function(response) {
				if (response.status === 200) {
					var modal = new bootstrap.Modal(document.getElementById('activityOption'));
					modal.show();
				} 
			})
			.then(function(data) {
...
var bouton = document.getElementById("addActivity-btn");
