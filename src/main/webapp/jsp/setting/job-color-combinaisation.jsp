	...
	<div class="pagetitle">
		<nav>
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item"><fmt:message key="job.color.combination"/></li>
	...
	<section class="section">
		<div class="row">
			<div class="col-lg-12">
				<div class="card">
					<div class="card-body">
						<h5 class="card-title"> <fmt:message key="job.color.combination"/></h5>
						...
						<table class="table datatable">
						  <thead style="background-color: #dddfe3;">
						    <tr>
						       ...
						       <th scope="col"><fmt:message key="front.color.number"/></th>
						        <th scope="col"><fmt:message key="back.color.number"/></th>
						        <th scope="col"><fmt:message key="number.signature"/></th>
						       <th scope="col"><fmt:message key="actions"/></th>
							</tr>
						  </thead>
						  <tbody>
						  <c:forEach var="colorCombination" items="${allJobColorCombination}" varStatus="loop">
						    <tr class="${loop.index % 2 == 0 ? 'even-row' : 'odd-row'}">
						    <th scope="row">${colorCombination.id}</th>
							   <td>${colorCombination.frontColorNumber}</td>
							   <td>${colorCombination.backColorNumber}</td>
							   <td>${colorCombination.numberOfSignature}</td>
							   <td>
							     <a>
