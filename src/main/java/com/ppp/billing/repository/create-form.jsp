    ...
    <form   style="background-color: white; margin: auto auto">
        ...
        <div class="my-3">
         ...
         <div class="my-3">
            ...
            <div class="col-md-6"> 
             <label>Name </label>
             <input type="text" class="form-control" id="emmergenceName" name="contact" value="${patient.emmergenceName}" required/> </div>
            
             <div class="col-md-6">
               <label>Contact: </label>
                 <input type="text" class="form-control" id="emmergenceContact" name="emmergenceContact" value="${patient.emmergencyContact}" required/></div>
            </div>
