...
<nav class="navbar navbar-light bg-white border-bottom px-3 sticky-top">
  <div class="container-fluid">
    <span class="navbar-brand mb-0 h1 d-flex align-items-center">
      <i class="bi bi-clock-history text-primary me-2"></i>Medicine History
    </span>
...
<main id="add-machine" class="mt-4">
  <div class="table-card">
    <div class="d-flex justify-content-between align-items-center mb-3">
      ...
      <span class="badge bg-secondary">Total : ${med.size()}</span>
    </div>
    ...
    <c:choose>
      <c:when test="${empty med}">
        <div class="text-center py-5">
          ...
          <p class="text-muted">Transactions will appear here automatically</p>
        </div>
      </c:when>
      <c:otherwise>
