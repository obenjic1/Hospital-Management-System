    ...
    <section class="section">
      <div class="row">       
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body" >
              <strong><h5 class="card-title" style="text-align:center; font-family: bold; color: #012970;"><fmt:message key="reprint.job"/> : ${job.referenceNumber}</h5></strong>
			     ...
			     <div class="row py-4">
				  ...
				  <div class ="col-lg-3 px8" style="position: relative; left: 10px;"> 
					<label for="" class="form-label"><a> <fmt:message key="job.type"/></a></label> 
						<select onchange="jobTypeChoice(this.selectedOptions[0])"  id="jobType" name="jobType" class="form-select" disabled="disabled">
			...
			<div class="row py-3">
			  ...
			  <div class ="col-lg-3 px8" id="closeDimensionDiv" style="position: relative; left: 10px;"> 
			   <label for="" class="form-label"> <a><fmt:message key="close.format"/></a> </label>
			     <div class="row">
				   <div class="col-6 volume-cover-l">
                     <input id="closeWidth" value="${job.closeWidth}" style="postion-relative-left:2px;position: relative;left: 4px;"  placeholder= "<fmt:message key="open.width"/> " name="closeWidth">
				     </div>
				     <div  class="col-6 volume-cover-w">
				       <input id="closeLength" value="${job.closeLength}"  placeholder="<fmt:message key="open.legnth"/>" name="closeLength">
                    </div>
				  </div>
			   </div>
		      </div>
 ...
 <!-- <----------------------------------- Tab2 ------------------------------->   
      ...
      <div class=" container tab-pane fade"  id="tab2" role="tabpanel" aria-labelledby="profile-tab">
         <div style="position: relative;bottom: -20px;" id="mainDiv" >	
         	 <c:if test="${not empty coverJobPaper}">
		   <div class="row py-4" id="coverInformations">
			 ...
			 <div class ="col-lg-2 px8" style="position: relative; left:10px;">
			   ...
			   <input style="postion-relative-left:2px;position: relative;left: 10px;" value="${coverJobPaper.grammage}" list="coverGrammage" id="coverGrammage" name="paperGrammage">
			  ...
			  <label for="" class="form-label"><a><fmt:message key="paper.size"/> (mm)</a></label>
				 <div class="row">
				   <div class="col-6 paper-size-width">
                     <input name="paperSizeWidth" onchange="resetNumberOfSignature(this)"  id="paperSizeWidth" placeholder="<fmt:message key='width'/>" value="${coverJobPaper.paperSizeWidth}" style="postion-relative-left:2px;position: relative;left: 4px;">
                   </div>
				   <div  class="col-6 paper-size-length"  style="position: relative;left: -25px;">
				      <input name="paperSizeLength" onchange="resetNumberOfSignature(this)" id="paperSizeLength" value="${coverJobPaper.paperSizeLength}" placeholder="<fmt:message key='length'/>" >
                    </div>
				  </div>
              </div>
              <div class ="col-lg-2 px8" style="position: relative;">
			    <label for="" class="form-label"><a><fmt:message key="cover.paper.price"/></a></label>
			     <input id="coverPaperUnitPrice" value="${coverJobPaper.unitPrice}" name="paperPrice">
              </div>
		    </div>	
		     </c:if>
		   <div id="contentDiv">   		
			<div class="row py-3"  style="display:none">
			  ...
			  <label for="" class="form-label"><a><fmt:message key="paper.size"/> (mm)</a></label>
				 <div class="row">
				   <div class="col-6 paper-size-width">
                     <input onchange="resetNumberOfSignature(this)" name="paperSizeWidth" paperSizeWidth placeholder="<fmt:message key='width'/>" value="650" type="number" style="postion-relative-left:2px;position: relative;left: 4px;">
                   </div>
				   <div  class="col-6 paper-size-length"  style="position: relative;left: -25px;">
		   ...
		   <div class="row py-3"  >
 			...
 			<div class ="col-lg-2 px8" style="position: relative; left: 10px;">
			  <label for="" class="form-label"><a><fmt:message key="paper.size"/> (mm)</a></label>
				 <div class="row">
				   <div class="col-6 paper-size-width">
                     <input onchange="resetNumberOfSignature(this)" name="paperSizeWidth" paperSizeWidth placeholder="<fmt:message key='width'/>" value="${contentJPaper.paperSizeWidth}" type="number" style="postion-relative-left:2px;position: relative;left: 4px;">
                   </div>
				   <div  class="col-6 paper-size-length"  style="position: relative;left: -25px;">
				      <input onchange="resetNumberOfSignature(this)" name="paperSizeLength" paperSizeLength value="${contentJPaper.paperSizeLength}" placeholder="<fmt:message key='length'/>" type="number">
                    </div>
				  </div>
              </div>
...
<%-- 			  </c:if> --%>
		     ...
		     <div class="row py-3">
			  ...
			  <div class="col-lg-2 px-8 coverDup" style="position: relative; left: 10px;float:left">
			    <label for="" class="form-label"><a> <fmt:message key="content.volume"/> </a></label> 
				<input type="text" value="${contentJPaper.volume}" contentVolume name="volume" oldValue="" onclick="this.oldValue=this.value" onchange="updateTotalContentvolume(this.value,this.oldValue)"  >
			  </div>
			  	<div class ="col-lg-2 px8" style="position: relative; left: 10px;">
			  <label for="" class="form-label"><a><fmt:message key="paper.size"/> (mm)</a></label>
				 <div class="row">
