...
<nav class="navbar navbar-light bg-white border-bottom px-3 sticky-top">
  <div class="container-fluid">
    <span class="navbar-brand mb-0 h1 d-flex align-items-center">
      <i class="bi bi-person-plus text-primary me-2"></i>Register New Staff
    </span>
    ...
    <form id="staffForm" class="row g-3 needs-validation" novalidate>
      ...
      <div class="col-md-6">
        ...
        <div class="input-group">
          ...
          <select id="department" name="department" class="form-select" onchange="getDepartment()">
            <c:forEach items="${departments}" var="departement">
              <option value="${departement.id}" data-department="${departement.name}">${departement.name}</option>
            </c:forEach>
          </select>
        </div>
      </div>
      <div class="col-md-6" id="percentageDiv" style="display:none">
        ...
        <div class="input-group">
          ...
          <input type="number" id="percentage" name="percentage" class="form-control" placeholder="0-100">
        </div>
      </div>
      ...
      <div class="col-md-6">
        ...
        <div class="input-group">
          ...
          <input type="text" id="speciality" name="speciality" class="form-control" placeholder="e.g. Cardiology">
        </div>
      </div>
      <div class="col-md-6">
        ...
        <div class="input-group">
          ...
          <input type="number" id="salary" name="salary" class="form-control" placeholder="0" min="0" step="0.01">
        </div>
      </div>
      ...
      <div class="col-12 text-center">
        <button type="button"  style="float:right"id="createBtn" onclick="addStaff()" class="btn btn-outline-primary btn-save">
          <i class="bi bi-check2-circle me-2"></i>Save Staff
        </button>
      </div>
    </form>
  </div><!-- /card-form -->
