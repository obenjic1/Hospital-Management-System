...
<main id="add-user">
		...
		<section>
			<div class="card">
				<div class="card-body">
					<h5 class="card-title text-center pb-0 fs-4">Register a new Staffs</h5>
					<p class="text-center small">Enter the personal detail to register a new Staff</p>
...
<!-- 						</div> -->
						<div class="col-md-3" style="  width: 20%; left: 21%; position: relative;bottom: -10px; ">
							<input type="button" id="createBtn"  onclick="addStaff()"  style=" bottom: -42%;" class="btn btn-outline-primary w-100" value="Save" >
						</div>
					</form>
				</div>
			</div>
