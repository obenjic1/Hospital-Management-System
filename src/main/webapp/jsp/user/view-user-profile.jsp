...
<!--                       </div> -->
                    ...
                    <div class="row mb-3">
                      <label for="mobile" class="col-md-4 col-lg-3 col-form-label">Date :</label>
                      <div class="col-md-8 col-lg-9">
	              ...
	              <div class="modal fade" id="userUdatedSuccessfully" tabindex="-1">
		            <div class="modal-dialog modal-dialog-centered">
		              <div class="modal-content">
		                  <button onclick="loadPage('/user/list-users')" type="button" class="btn-close" 
                ...
                <div class="tab-pane fade pt-3" id="profile-change-password">
                  ...
                  <form style="margin-left: 5%">
                    ...
                    <div class="text-center">
                      <button type="submit" class="btn btn-primary" style="left: 40%; bottom: 2%;">Change Password</button>
                    </div>
