...
<!-- 	action="machine/add-machine -->
	<section>
			<div class="card">
				<div class="card-body">
					<h5 class="card-title text-center pb-0 fs-4">Payment History</h5>
...
<!-- 								<th scope="col">Action </th> -->
								...
								<tbody>
								 <c:forEach var="med" items="${payment.tracking}" varStatus="loop">
								 <tr>
								  <td>${med.creationDate}" </td>
								    <td>${med.performedBy}</td>
<%-- 								    <td>${med.action}</td> --%>
