		   ...
		   <div id="contentDiv">   		
			<div class="row py-3"  style="display:none">
			  ...
			  <label for="" class="form-label"><a><fmt:message key="paper.size"/> (mm)</a></label>
				 <div class="row">
				   <div class="col-6 paper-size-width">
                     <input onchange="resetNumberOfSignature(this)" name="paperSizeWidth" paperSizeWidth placeholder="<fmt:message key='width'/>" value="620" type="number" style="postion-relative-left:2px;position: relative;left: 4px;">
                   </div>
				   <div  class="col-6 paper-size-length"  style="position: relative;left: -25px;">
